...
const ViewFieldSupervisorDetail: React.FC<ModalProps> = ({ isOpen, onClose, user }) => {
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              <strong>  Field Supervisor Number:</strong> {user?.id}
            </p>
            <p className="text-gray-700 dark:text-gray-300">
...
export default ViewFieldSupervisorDetail;
