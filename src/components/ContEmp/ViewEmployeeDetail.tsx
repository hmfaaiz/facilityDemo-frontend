...
// const ViewEmployeeDetail: React.FC<ModalProps> = ({ isOpen, onClose, user }) => {
...
const ViewEmployeeDetail: React.FC<ModalProps> = ({
  ...
  useEffect(() => {
    axios({
      method: "get",
      url: `${base_url}contractoremp/GetSchedular?empId=${user.id}`,
      headers: {
...
<p className="text-gray-700 dark:text-gray-300">
  ...
  {(() => {
    ...
    const isSameDay = dateFromData.toDateString() === today.toDateString();
