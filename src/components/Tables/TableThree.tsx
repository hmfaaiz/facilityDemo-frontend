...
// import ViewRoomDetail from "../RoomModal/ViewRoomDetail";
...
const TableThree = () => {
  ...
  let roomData = reduxData.rooms

  const deleteRoom = async (roomId: number) => {
    try {
      const response = await axios.delete(`${base_url}room?id=${roomId}`, {
        headers: {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
              ...
              <tr key={room.id}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button className="hover:text-primary" onClick={()=>openViewModal(room)}>
                      <svg
      ...
      {/* <UpdateRoomModal isOpen={isModalOpen} onClose={closeModal} room={selectedRoom}/>
      <ViewRoomDetail isOpen={isViewModalOpen} onClose={closeViewModal} room={selectedRoom} /> */}
